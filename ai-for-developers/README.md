...
```mermaid
flowchart TD
    subgraph S1["🚀 STAGE 1: The Velocity Mindset & Foundations"]
        P01["Page 01: The Velocity Mental Model<br/><sub>From Typist to Architect, Context-First Prompting & Guardrails</sub>"]
        P02["Page 02: Accelerating Backend & APIs<br/><sub>0-to-1 REST APIs, Flyway Migrations, DTOs & Contracts</sub>"]
    end

    subgraph S2["⚡ STAGE 2: Debugging, Quality & Testing"]
        P03["Page 03: Rapid Debugging & Troubleshooting<br/><sub>Stack Trace Triage, Log Pattern Analysis, Fix & Explain</sub>"]
        P04["Page 04: Accelerating Testing & Quality<br/><sub>JUnit 5, MockMvc, Testcontainers & Pre-PR Code Reviews</sub>"]
    end

    subgraph S3["🛠️ STAGE 3: Modern Tooling & Enterprise Scale"]
        P05["Page 05: Modern AI Developer Tools & Rules<br/><sub>Cursor, Claude Cowork, Copilot, .cursorrules & Context Management</sub>"]
        P06["Page 06: Large-Scale & Enterprise Codebases<br/><sub>500k+ LOC Monoliths, Multi-Module Tracing, OpenRewrite + AI</sub>"]
    end

    subgraph S4["🏛️ STAGE 4: Architecture & Problem Solving"]
