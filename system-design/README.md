...
| **14** | Design a Distributed Vector Database for AI/RAG (Pinecone) | HNSW multi-layer graph, IVF-PQ quantization, bitset filtering, S3 segments | [14-design-a-distributed-vector-database-pinecone-milvus.md](hld-case-studies/14-design-a-distributed-vector-database-pinecone-milvus.md) |
| **15** | Design a High-Throughput Payment Gateway & Ledger (Stripe) | Immutable double-entry ledger, Redis idempotency keys, automated reconciliation | [15-design-a-high-throughput-payment-gateway-and-ledger-stripe.md](hld-case-studies/15-design-a-high-throughput-payment-gateway-and-ledger-stripe.md) |
| **16** | Design a Real-Time Ad Click Stream Event Aggregator (Google/Meta) | Apache Flink event-time watermarking, HyperLogLog, ClickHouse OLAP, fraud filters | [16-design-a-real-time-ad-click-event-aggregator-google-meta.md](hld-case-studies/16-design-a-real-time-ad-click-event-aggregator-google-meta.md) |
| **17** | Design a Global Live Video Streaming Platform (Twitch) | Low-Latency HLS (LL-HLS), SRT/RTMP ingest, GPU transcoder fleet, CDN origin shield | [17-design-a-global-live-video-streaming-platform-twitch-youtube-live.md](hld-case-studies/17-design-a-global-live-video-streaming-platform-twitch-youtube-live.md) |
