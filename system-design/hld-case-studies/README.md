...
| **10** | **Design a Distributed Web Crawler (Google Search)** | Distributed URL Frontier, Bloom Filters, SimHash | Politeness scheduling, 1B pages/mo, DNS caching, spider traps, deduplication | [10-design-a-distributed-web-crawler-google-search.md](./10-design-a-distributed-web-crawler-google-search.md) |
| **11** | **Design a Distributed Metrics & Telemetry System (Datadog)** | Time-Series DB (TSDB), Gorilla Compression, Kafka | 10M points/sec, delta-of-delta timestamps, XOR float compression, Roaring Bitmaps | [11-design-a-distributed-metrics-and-telemetry-system-datadog.md](./11-design-a-distributed-metrics-and-telemetry-system-datadog.md) |
| **12** | **Design a Collaborative Document Editor (Google Docs)** | Operational Transformation (OT), WebSockets, ScyllaDB | Sub-100ms multi-user convergence, character shift matrices, collaborative undo/redo | [12-design-a-collaborative-real-time-document-editor-google-docs.md](./12-design-a-collaborative-real-time-document-editor-google-docs.md) |
| **13** | **Design a Proximity & Nearby Search Service (Yelp / Maps)** | In-Memory Quadtree, Geohash, S2 / H3, PostGIS | 15k QPS, dynamic 2D spatial subdivision, dense urban hotspots vs sparse rural queries | [13-design-a-proximity-and-nearby-search-service-yelp-maps.md](./13-design-a-proximity-and-nearby-search-service-yelp-maps.md) |
| **14** | **Design a Distributed Vector Database for AI/RAG (Pinecone / Milvus)** | HNSW, IVF-PQ, S3 Segment Store, Kafka WAL | High-dimensional similarity search ($D=1536$), filtered bitset ANN, vector quantization | [14-design-a-distributed-vector-database-pinecone-milvus.md](./14-design-a-distributed-vector-database-pinecone-milvus.md) |
| **15** | **Design a High-Throughput Payment Gateway & Ledger (Stripe)** | Double-Entry Ledger, PostgreSQL / CockroachDB, Redis Idempotency | Exactly-once processing, balanced debit/credit invariants ($\sum D - \sum C = 0$), reconciliation | [15-design-a-high-throughput-payment-gateway-and-ledger-stripe.md](./15-design-a-high-throughput-payment-gateway-and-ledger-stripe.md) |
| **16** | **Design a Real-Time Ad Click Stream Event Aggregator (Google / Meta)** | Apache Flink, Kafka, ClickHouse / Pinot, HyperLogLog | 1M clicks/sec, event-time watermarking, click fraud detection, two-phase commit sink | [16-design-a-real-time-ad-click-event-aggregator-google-meta.md](./16-design-a-real-time-ad-click-event-aggregator-google-meta.md) |
| **17** | **Design a Global Live Video Streaming Platform (Twitch)** | LL-HLS, SRT / RTMP, GPU Transcoder Cluster, CDN Origin Shield | Sub-2s glass-to-glass latency, 40 Tbps peak egress, 50k chat msgs/sec sampling | [17-design-a-global-live-video-streaming-platform-twitch-youtube-live.md](./17-design-a-global-live-video-streaming-platform-twitch-youtube-live.md) |
